    ...
    public void recover(int id) {
        ...
        switch (sysLog.getType()){
            ...
            case LogType.TYPE_ROLE_ACL:
                ...
                sysRoleAclService.changeRoleAcls(sysLog.getTargetId(), JsonMapper.string2Obj(sysLog.getOldValue(),
            ...
            case LogType.TYPE_ROLE_USER:
                ...
                sysRoleUserService.changeRoleUsers(sysLog.getTargetId(), JsonMapper.string2Obj(sysLog.getOldValue(),
                        new TypeReference<List<Integer>>() {
                }));
                break;
            default:;

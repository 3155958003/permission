...
public class SysTreeService {
    ...
    public List<AclModuleLevelDto> aclModuleListToTree(List<AclModuleLevelDto> dtoList){
        ...
        Collections.sort(rootList, aclModuleSeqCompartor);
    ...
    public void transformAclModuleTree(List<AclModuleLevelDto> dtoList, String level,
        ...
        for (int i = 0; i < dtoList.size(); i++){
            ...
            if (CollectionUtils.isNotEmpty(tempList)){
                Collections.sort(tempList, aclModuleSeqCompartor);
     ...
     * 权限模块的排序
     */
    public Comparator<AclModuleLevelDto> aclModuleSeqCompartor = new Comparator<AclModuleLevelDto>() {
        @Override
